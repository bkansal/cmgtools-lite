...
config.JobType.inputFiles = ['FrameworkJobReport.xml','heppy_config.py','heppy_crab_script.py','python.tar.gz','options.json' ]
config.JobType.outputFiles = ['output.log.tgz'] 
