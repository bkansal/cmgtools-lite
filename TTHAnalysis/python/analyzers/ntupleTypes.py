...
jetTypeSusyExtraLight = NTupleObjectType("jetSusyExtraLight",  baseObjectTypes = [ jetTypeSusy ], variables = [
    ...
    NTupleVariable("chHEF", lambda x : x.correctedJet("Uncorrected").chargedHadronEnergyFraction(), float, mcOnly = False, help="chargedHadronEnergyFraction (relative to uncorrected jet energy)"),
    NTupleVariable("neHEF", lambda x : x.correctedJet("Uncorrected").neutralHadronEnergyFraction(), float, mcOnly = False,help="neutralHadronEnergyFraction (relative to uncorrected jet energy)"),
])
...
jetTypeSusyExtra = NTupleObjectType("jetSusyExtra",  baseObjectTypes = [ jetTypeSusyExtraLight ], variables = [
    ...
    # --------------- 
    NTupleVariable("phEF", lambda x : x.correctedJet("Uncorrected").photonEnergyFraction(), float, mcOnly = False,help="photonEnergyFraction (relative to uncorrected jet energy)"),
    NTupleVariable("eEF", lambda x : x.correctedJet("Uncorrected").electronEnergyFraction(), float, mcOnly = False,help="electronEnergyFraction (relative to uncorrected jet energy)"),
    NTupleVariable("muEF", lambda x : x.correctedJet("Uncorrected").muonEnergyFraction(), float, mcOnly = False,help="muonEnergyFraction (relative to uncorrected jet energy)"),
    NTupleVariable("HFHEF", lambda x : x.correctedJet("Uncorrected").HFHadronEnergyFraction(), float, mcOnly = False,help="HFHadronEnergyFraction (relative to uncorrected jet energy)"),
    NTupleVariable("HFEMEF", lambda x : x.correctedJet("Uncorrected").HFEMEnergyFraction(), float, mcOnly = False,help="HFEMEnergyFraction (relative to uncorrected jet energy)"),
